...
|---|---|---|
| Tactical Combat | Could explode scope. | Build the smallest full tactical battle slice: few unit types, clear grid/arena, basic abilities, and guarded-site integration. |
