...
- [[production/stories/story-map-visual-slice-001-physical-arctic-adventure-map-and-shell]] — READY / approved and Unity-pointer-activated sole current physical-map-and-shell packet.
- `production/sprints/codex-story-map-visual-slice-001.prompt.txt` — current runnable Unity implementation contract.
...
## Production Evidence and Playtests

- [[production/playtests/playtest-journal]] — active playtest journal template and exact-complaint preservation index.
