...
4. `STORY-FACTION-COMPOSITION-001` — READY / bounded existing-line proxy mapping approved through the explicit use-best-judgment fallback; current three-line faction composition and tactical identity packet.
