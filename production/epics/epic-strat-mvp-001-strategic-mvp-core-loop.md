...
| [STORY-TAC-002 Minimal Hex Board and Stack Placement](../stories/story-tac-002-minimal-hex-board-and-stack-placement.md)                         | READY                                     | Logic + Visual/Feel foundation    | STORY-TAC-001, tactical-combat hex decision                                                               | Hex coordinate tests, stack placement tests, scene evidence if touched               |
