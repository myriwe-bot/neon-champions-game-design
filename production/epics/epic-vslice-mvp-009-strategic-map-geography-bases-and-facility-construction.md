...
First child story DONE / merged: `STORY-MAP-REAL-001 Scenario-Authored Strategic Map Shell`. Next recommended child story drafted as READY-candidate / approval pending: `STORY-BASE-001 Base Definition and Facility Construction Core`.
...
| [STORY-BASE-001 Base Definition and Facility Construction Core](../stories/story-base-001-base-definition-and-facility-construction-core.md) | READY-candidate / approval pending | Strategic Rules + UI | MAP-REAL-001 DONE | Required: facility validation, build-command tests, base panel evidence |
...
- [x] At least one child story has merged. `STORY-MAP-REAL-001` is DONE / merged; `STORY-BASE-001` is READY-candidate / approval pending.
...
APPROVED / PLANNED. `STORY-MAP-REAL-001` is DONE / merged; `STORY-BASE-001` is drafted as READY-candidate / approval pending. No Unity implementation is authorized until a child story is READY / approved.
