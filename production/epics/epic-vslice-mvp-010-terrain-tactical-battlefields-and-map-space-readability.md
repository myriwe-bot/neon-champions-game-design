...
APPROVED / IN PROGRESS. `STORY-TERRAIN-001` and `STORY-TERRAIN-002` are DONE / merged. Current READY / approved Unity implementation packet is `STORY-TERRAIN-003`. No Unity implementation is authorized directly by this epic. Agents and Codex may only implement READY child stories.
...
| [STORY-TERRAIN-003 Tactical Blockers and Simple Defensive Terrain](../stories/story-terrain-003-tactical-blockers-and-simple-defensive-terrain.md) | READY / approved | Tactical Rules + UI | TERRAIN-002 DONE | Runnable prompt prepared |
...
APPROVED / IN PROGRESS. `STORY-TERRAIN-001` and `STORY-TERRAIN-002` are DONE / merged. Current READY / approved Unity implementation packet: `STORY-TERRAIN-003 Tactical Blockers and Simple Defensive Terrain` with a runnable prompt.
