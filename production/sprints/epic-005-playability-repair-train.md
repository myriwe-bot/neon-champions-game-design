...
Approved direction after human playtest rejected EPIC-005 closeout on 2026-06-13. Run one story at a time. Only `STORY-QA-006` is the current READY implementation packet.
...
| ---: | --- | --- | --- |
| 1 | [STORY-QA-006 Strategic and Tactical State/Action Feedback Readability Pass](../stories/story-qa-006-strategic-tactical-state-action-feedback-readability-pass.md) | READY / approved | Current actor, clickable actions, denial reasons, results, and target clarity across strategic/tactical modes. |
| 2 | [STORY-QA-007 Champion Encounter Initiation Clarity](../stories/story-qa-007-champion-encounter-initiation-clarity.md) | READY-candidate | Clarify how Champion-vs-Champion encounters start or why movement/engagement is denied. |
