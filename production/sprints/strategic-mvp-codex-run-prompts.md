...
**Current READY / approved Unity implementation packet:** `STORY-STRAT-READ-002 Strategic Map Readability Pass`. Use the checked-in prompt file below.

`STORY-INTEL-001`, `STORY-INTEL-002`, `STORY-INTEL-003`, `STORY-INTEL-004`, `STORY-UX-001`, `STORY-QA-005`, `STORY-CMD-001`, `STORY-CMD-002`, `STORY-CMD-003`, `STORY-CMD-004`, `STORY-QA-006`, `STORY-QA-007`, `STORY-CMD-005`, `STORY-STRAT-OBJECTIVE-001`, `STORY-TAC-AP-001`, and `STORY-TAC-AI-001` are DONE / merged. `STORY-STRAT-READ-002` is READY / approved as the current EPIC-007 implementation packet.

## Copy-safe prompt-file mode

If PowerShell shows `>>`, the here-string was not closed correctly. Avoid here-strings entirely and run Codex from checked-in prompt files instead.

Current prompt file: `production/sprints/codex-story-strat-read-002.prompt.txt`. Historical prompt files remain for audit only.
...
Codex must push `story/STORY-STRAT-READ-002-strategic-map-readability-pass` or explicitly report why pushing/PR creation was impossible. Final response must include tests/evidence, PR URL/number if created, CI status or blocker, and omissions/deferred work.
