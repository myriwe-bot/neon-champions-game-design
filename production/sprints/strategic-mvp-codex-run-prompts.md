...
No current READY / approved Unity implementation packet. Proposed next packet: **STORY-TAC-AI-001 Neutral Guard One-Step CombatAI** is READY-candidate / approval pending.

`STORY-INTEL-001`, `STORY-INTEL-002`, `STORY-INTEL-003`, `STORY-INTEL-004`, `STORY-UX-001`, `STORY-QA-005`, `STORY-CMD-001`, `STORY-CMD-002`, `STORY-CMD-003`, `STORY-CMD-004`, `STORY-QA-006`, `STORY-QA-007`, `STORY-CMD-005`, `STORY-STRAT-OBJECTIVE-001`, and `STORY-TAC-AP-001` are DONE / merged. `STORY-TAC-AI-001` is the next EPIC-006 candidate packet and is not approved for implementation yet.

## Copy-safe prompt-file mode

If PowerShell shows `>>`, the here-string was not closed correctly. Avoid here-strings entirely and run Codex from checked-in prompt files instead.

Candidate prompt file: `production/sprints/codex-story-tac-ai-001.prompt.txt`. It self-blocks until the story is promoted to READY / approved. Historical prompt files remain for audit only.
...
Do not run Codex for `STORY-TAC-AI-001` until human approval promotes the story to READY / approved. After approval, Codex must push `story/STORY-TAC-AI-001-neutral-guard-one-step-combat-ai` or explicitly report why pushing/PR creation was impossible. Final response must include tests/evidence, PR URL/number if created, CI status or blocker, and omissions/deferred work.
