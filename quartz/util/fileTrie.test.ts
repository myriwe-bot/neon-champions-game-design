...
describe("FileTrie", () => {
  ...
  describe("add", () => {
    ...
    test("should add nested files", () => {
      ...
      assert.strictEqual(
        trie.children[1].children[0].children[0].slug,
        "a/b/c/index",
      );
      assert.strictEqual(trie.children[1].children[0].children[0].data, data2);
      assert.strictEqual(
        trie.children[1].children[0].children[0].children.length,
        0,
      );
    });
  });
  ...
  describe("map", () => {
    ...
    test("map over folders should work", () => {
      ...
      assert.strictEqual(
        trie.children[1].children[0].displayName,
        "Folder: b with space",
      );
      assert.strictEqual(
        trie.children[1].children[0].children[0].displayName,
        "File: Test2",
      );
    });
  });
  ...
  describe("fromEntries", () => {
    test("nested", () => {
      const trie = FileTrieNode.fromEntries([
        [
          "index" as FullSlug,
          { title: "Root", slug: "index", filePath: "index.md" },
        ],
        [
      ...
      assert.strictEqual(
        trie.children[0].children[2].slug,
        "folder/folder2/index",
      );
