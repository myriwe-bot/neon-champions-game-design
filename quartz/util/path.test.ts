...
describe("transforms", () => {
  ...
  test("joinSegments", () => {
    ...
    assert.strictEqual(
      path.joinSegments("https://example.com", "a"),
      "https://example.com/a",
    );
    assert.strictEqual(
      path.joinSegments("https://example.com/", "a"),
...
describe("resolveRelative", () => {
  test("from index", () => {
    assert.strictEqual(
      path.resolveRelative("index" as FullSlug, "index" as FullSlug),
      "./",
    );
    assert.strictEqual(
      path.resolveRelative("index" as FullSlug, "abc" as FullSlug),
      "./abc",
    );
    assert.strictEqual(
  ...
  test("from nested page", () => {
    assert.strictEqual(
      path.resolveRelative("abc/def" as FullSlug, "index" as FullSlug),
      "../",
    );
    assert.strictEqual(
      path.resolveRelative("abc/def" as FullSlug, "abc" as FullSlug),
      "../abc",
    );
    assert.strictEqual(
  ...
  test("with index paths", () => {
    assert.strictEqual(
      path.resolveRelative("abc/index" as FullSlug, "index" as FullSlug),
      "../",
    );
    assert.strictEqual(
    ...
    assert.strictEqual(
      path.resolveRelative("index" as FullSlug, "abc/index" as FullSlug),
      "./abc/",
    );
    assert.strictEqual(
  ...
  test("with simple slugs", () => {
    assert.strictEqual(
      path.resolveRelative("abc/def" as FullSlug, "" as SimpleSlug),
      "../",
    );
    assert.strictEqual(
      path.resolveRelative("abc/def" as FullSlug, "ghi" as SimpleSlug),
      "../ghi",
    );
    assert.strictEqual(
      path.resolveRelative("abc/def" as FullSlug, "ghi/" as SimpleSlug),
